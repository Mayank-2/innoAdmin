...
function AddUpcomingProduct({ setAddProduct,getUpcomingProduct }) {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full bg-red-500 text-white font-bold py-2 px-4 my-1 rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        Cancel
      </button>
    </form>
